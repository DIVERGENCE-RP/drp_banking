...
local Banks1 = BoxZone:Create(vector3(1175.8, 2706.82, 38.09), 2.0, 0.8, {
    name = "banking",
    heading = 271,
    minZ = 36.99,
    maxZ = 40.59
...
local Banks2 = BoxZone:Create(vector3(-2962.62, 482.18, 15.7), 2.0, 0.8, {
    name = "banking",
    heading = 177,
    minZ = 14.6,
    maxZ = 18.2
...
local Banks3 = BoxZone:Create(vector3(252.63, 222.03, 106.29), 2.0, 0.8, {
    name = "banking",
    heading = 70,
    minZ = 105.19,
    maxZ = 108.79
...
local Banks4 = BoxZone:Create(vector3(242.22, 224.99, 106.29), 2.0, 0.8, {
    name = "banking",
    heading = 70,
    minZ = 105.19,
    maxZ = 108.79
...
local Banks5 = BoxZone:Create(vector3(-1213.29, -331.08, 37.78), 2.0, 0.8, {
    name = "banking",
    heading = 118,
    minZ = 36.58,
    maxZ = 40.18,
...
local Banks6 = BoxZone:Create(vector3(-351.63, -49.67, 49.04), 2.0, 0.8, {
    name = "banking",
    heading = 71,
    minZ = 47.99,
    maxZ = 51.39
...
local Banks7 = BoxZone:Create(vector3(313.58, -278.91, 53.92), 2.0, 0.8, {
    name = "banking",
    heading = 70,
    minZ = 52.87,
    maxZ = 56.27
...
local Banks8 = BoxZone:Create(vector3(149.22, -1040.5, 29.37), 2.0, 0.8, {
    name = "banking",
    heading = 70,
    minZ = 28.32,
    maxZ = 31.72,
